...
public class SystemLogAspect {
    ...
    private final ISysAdminLogService logService;

    private final HttpServletRequest request;

    private final IpInfoUtil ipInfoUtil;

    public SystemLogAspect(ISysAdminLogService logService, HttpServletRequest request, IpInfoUtil ipInfoUtil) {
    ...
    private static class SaveSystemLogThread implements Runnable {
        ...
        private final SysAdminLog log;

        private final ISysAdminLogService logService;

        SaveSystemLogThread(SysAdminLog log, ISysAdminLogService logService) {
            this.log = log;
            this.logService = logService;
        }
